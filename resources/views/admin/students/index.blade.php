...
$(document).ready(function () {
    studentsTable = $('#studentsTable').DataTable({
        ...
        columns: [
            ...
            { data: 'roll_no',  name: 'students.roll_no' },
            { data: 'class',    name: 'classes.name', orderable: false },
            { data: 'guardian', name: 'students.guardian_name', orderable: false },
            { data: 'gender',   name: 'students.gender' },
            { data: 'status',   name: 'students.status', orderable: false, searchable: false },
